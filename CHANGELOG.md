...
## [0.2.0](https://github.com/carlosvin/tanstack-fullstack-ai-template/compare/v0.1.0...v0.2.0) (2026-09-20)
...
* align example app with skill type-safety contract ([96e7f1c](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/96e7f1cdef0e232d9f42874205e3f602e2120606))
...
* migrate repository skills to agentskills.io only ([#39](https://github.com/carlosvin/tanstack-fullstack-ai-template/issues/39)) ([05b5f9f](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/05b5f9f6cf9dfdf0f6a31ffb826cbad9ae06a07e))
...
* parse remaining untrusted edges with Zod schemas ([dec6b06](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/dec6b06820befd5433b1cd615aac67c2407e1465))
* parse trust boundaries with the runtime validator ([bfd21a8](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/bfd21a81494cc26974e1fcb024474d9b43b59414))
...
* use agentskills.io SKILL.md as the only skill format ([02b845e](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/02b845e36374dc7712feaedf60a64d4863347f35))
* validate published skills with Waza in CI ([d431645](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/d4316458abb50d8f3ad920d803cd81be2a75acbe))
* validate published skills with Waza in CI ([#38](https://github.com/carlosvin/tanstack-fullstack-ai-template/issues/38)) ([d72420c](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/d72420c3e77c5787400584aee33c70c87430cff7))
...
* address Copilot review on Waza CI integrity and form titles ([1bff79f](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/1bff79fa4b8e47482a094bf91bc360bc77eb68d4))
* address PR review — AGENTS.md env paths and type-only import eval ([aa4a722](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/aa4a7226d6f9ce81eb1be7cd2594b0f442b53ad1))
...
* create results directory before waza run in CI ([adcb133](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/adcb133e4dfde0070cfad4cdf34b96e929ad983e))
...
* keep server env schema metadata out of the client bundle ([897536c](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/897536c1b37ac42b14b9d548cd8ca93621d87348))
* keep server env schema metadata out of the client bundle ([#35](https://github.com/carlosvin/tanstack-fullstack-ai-template/issues/35)) ([90ecfb0](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/90ecfb072a55223f8fdb7b68c27d68ed10d43970))
...
* require Agent Skill description to be a YAML string ([4c3d894](https://github.com/carlosvin/tanstack-fullstack-ai-template/commit/4c3d894c845e6bd65f0ef4139941699dfbed6564))
