 ...
 * On 401, throws before the handler runs; the handler can assume context.accessTicket.identity has email.
 *
 * Chains authMiddleware so that context.accessTicket is typed
