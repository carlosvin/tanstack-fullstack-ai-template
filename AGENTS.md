...
- **Deploys are Netlify-only.** PR previews and production deploys come from Netlify Git integration, not GitHub Actions. GHA validates and runs Release Please / commitlint; Netlify publishes. Confirm deploy previews are enabled in the Netlify site settings.
